...
l=new WeakMap;!1==="HYPE_eventListeners"in window&&(window.HYPE_eventListeners=[]);window.HYPE_eventListeners.push({type:"HypeSceneLoad",callback:function(b,c,a){m(c)}});g&&document.addEventListener("DOMContentLoaded",function(){setTimeout(function(){m(document.body)},100)});return{version:"1.1.3"}}());
